...
cp "$SRC/kura/oss-fuzz/fuzz_convert.dict" "$OUT/fuzz_convert.dict"
cp "$SRC/kura/oss-fuzz/fuzz_profile.dict" "$OUT/fuzz_profile.dict"
cp "$SRC/kura/oss-fuzz/fuzz_invoice.dict" "$OUT/fuzz_invoice.dict"
