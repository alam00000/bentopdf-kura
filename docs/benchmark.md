...
This document records a robustness benchmark of the Kura engine (BentoPDF Kura Engine (kura) 1.1.0) on 30,677 real PDFs from public corpora, on Darwin arm64, Apple M4. Every file was converted to PDF/A-2b with the CLI exactly as shipped, one process per file, with the default 120-second watchdog. The raw per-file data is in [bench/RESULTS.csv](https://github.com/alam00000/bentopdf-kura/blob/main/bench/RESULTS.csv); every document's origin and SHA-256 are in [bench/MANIFEST.csv](https://github.com/alam00000/bentopdf-kura/blob/main/bench/MANIFEST.csv), so the run can be reproduced with `make bench` from a checkout of the repository.
...
- [The pdf.js regression corpus, part 1 of 1](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/pdfjs-01.md) (966 files)
- [Web PDFs, Common Crawl CC-MAIN-2021-31, part 1 of 1](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/cc-01.md) (1,927 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 1 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-01.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 2 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-02.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 3 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-03.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 4 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-04.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 5 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-05.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 6 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-06.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 7 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-07.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 8 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-08.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 9 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-09.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 10 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-10.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 11 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-11.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 12 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-12.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 13 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-13.md) (2,000 files)
- [Web PDFs, DARPA SafeDocs CC-MAIN-2021-31, part 14 of 14](https://github.com/alam00000/bentopdf-kura/blob/main/bench/documents/safedocs-14.md) (1,784 files)
